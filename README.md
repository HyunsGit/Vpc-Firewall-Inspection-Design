...
* [방화벽 고도화 — Intra\-VPC 트래픽 검사](#방화벽-고도화--intra-vpc-트래픽-검사)
  * [문서 목록](#문서-목록)
  * [배경 및 목표](#배경-및-목표)
    * [목표](#목표)
    * [설계 원칙](#설계-원칙)
  * [아키텍처 요약](#아키텍처-요약)
  * [문서별 핵심 내용](#문서별-핵심-내용)
    * [1\. TGW Hairpin 제약 → 불가](#1-tgw-hairpin-제약--불가)
    * [2\. Cross\-VPC ENI 구성 → 해법](#2-cross-vpc-eni-구성--해법)
    * [3\. Inter\-VPC 비대칭 라우팅 대응 → 필수 조치](#3-inter-vpc-비대칭-라우팅-대응--필수-조치)
  * [디렉토리 구조](#디렉토리-구조)
  * [관련 환경](#관련-환경)
