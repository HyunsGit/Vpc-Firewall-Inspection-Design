...
Hub VPC의 방화벽(External-FW)에 보조 trust 포트(Secondary Trust ENI)를 추가하고, 이 ENI를 Prod VPC의 trust 서브넷에 배치함. 이후 Prod App/DB 서브넷의 more-specific 경로 target을 해당 ENI로 지정함.
